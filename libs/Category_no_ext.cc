...
*/
  ...
  float WP_VBF2j = getDVBF2jetsWP(ZZMass, false);
  float WP_VBF1j = getDVBF1jetWP(ZZMass, false);
  float WP_WHh = getDWHhWP(ZZMass, false);
  float WP_ZHh = getDZHhWP(ZZMass, false);
